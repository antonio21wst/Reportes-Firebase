...
// Clave para guardar en el almacenamiento local (específica para La Joya)
const CACHE_KEY = "laJoya_dashboardData";
...
// NUEVO: Función para actualizar la interfaz (separada para usarla con caché y Firebase)
